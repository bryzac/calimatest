...
(async () => {
    try {
        ...
        if (pathName === '/') {
            ...
            ifContact = `
                <div class="flex flex-wrap place-content-evenly gap-4 h-12 mt-4">
                    ...
                    <a class="flex flex-col" href="mailto:habitantesdelacalima@gmail.com"><img class="h-[80px]" src="../images/gmail.svg" alt=""><h4>Coreeo</h4></a>
                </div>
            `;
